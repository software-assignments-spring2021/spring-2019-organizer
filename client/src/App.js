...
function Login() {
  return (
  <div>
    <div>Welcome to Organizer! Please login using your google account</div>
    <button type="button" class="google-button">
      ...
      <a href='http://localhost:5000/auth/google' class="google-button__text">Sign in with Google</a>
    </button>
  </div>)
}
